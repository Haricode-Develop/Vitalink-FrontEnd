...
import {Form, Input, Label, Title, Button, Section, Select, BodyMapStyle, DatePickerWrapper, IndicadorGuardado, ListItem, ButtonAceptar, ButtonCancelar} from './FichaColumnaToracicaStyle';
...
const FichaColumnaToracica = ({ resetBodyMap } ) => {
    ...
    useEffect(() => {
        localStorage.setItem('datosFormularioPacienteColumnaToracica', JSON.stringify(formValues));
    ...
    const exportPDF = async (nombre) => {
        ...
        const canvas = await html2canvas(formulario, {
            ...
            ignoreElements: (element) => {
                // Ignorar elementos que no desees renderizar
                return false;
            }
        });
            ...
            <Form id="formulario" onSubmit={handleSubmit}>
                ...
                <div style={{ marginBottom: '1rem' }}>
                    ...
                    <div style={{ display: 'flex', flexWrap: 'wrap', gap: '10px', alignItems: 'center',marginTop: '20px' }}>
                        ...
                        <div style={{ marginLeft: 'auto' }}>
                            <div>
                                <label>
                                    <input type="checkbox" name="sintomasPeores" value="Girando cuello" onChange={handleInputChange} checked={formValues.sintomasPeores.includes('Girando cuello')}/> Girando cuello
                                </label>
                            </div>
                        </div>
                        <div>
                            <label>
                                <input type="checkbox" name="sintomasPeores" value="Tronco" onChange={handleInputChange} checked={formValues.sintomasPeores.includes('Tronco')} /> Tronco
                            </label>
                        </div>
                ...
                <div style={{ marginBottom: '1rem' }}>
                    ...
                    <div style={{ display: 'flex', flexWrap: 'wrap', gap: '10px', alignItems: 'center',marginTop: '20px' }}>
                        ...
                        <div>
                            <label>
                                <input type="checkbox" name="sintomasMejores" value="Levantarse" onChange={handleInputChange} checked={formValues.sintomasMejores.includes('Levantarse')} /> Levantarse
                            </label>
                        </div>
                        ...
                        <div style={{ marginLeft: 'auto' }}>
                            <div>
                                <label>
                                    <input type="checkbox" name="sintomasMejores" value="Girando cuello" onChange={handleInputChange} checked={formValues.sintomasMejores.includes('Girando cuello')} /> Girando cuello
                                </label>
                            </div>
                        </div>
                        <div>
                            <label>
                                <input type="checkbox" name="sintomasMejores" value="Tronco" onChange={handleInputChange} checked={formValues.sintomasMejores.includes('Tronco')} /> Tronco
                            </label>
                        </div>
                    ...
                    <div>
                        ...
                        <label>
                            ...
                            <input
                                ...
                                value="Normal"
                                onChange={handleInputChange}
                                checked={formValues.marcha === 'Normal'}
                        ...
                        <label>
                            ...
                            <input
                                ...
                                value="Anormal"
                                onChange={handleInputChange}
                                checked={formValues.marcha === 'Anormal'}
                ...
                <BodyMapStyle>
                    <BodyMap key={"BodyMapColumnaToracica"}  onAreaSelected={handleBodyPartSelection}/>
                </BodyMapStyle>
...
export default FichaColumnaToracica;
